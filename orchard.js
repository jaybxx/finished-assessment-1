...
for (const fuji of fujiAcres) {
    totalAcres = totalAcres + fuji
};

for (const gala of galaAcres) {
  totalAcres = totalAcres + gala
};
for (const pink of pinkAcres) {
    totalAcres = totalAcres + pink
};
...
for (let fuji of fujiTons) {
    fujiPounds += fuji * 2000
};
for (let gala of galaTons) {
    galaPounds += gala * 2000
};
for (let pink of pinkTons) {
    pinkPounds += pink * 2000
};
